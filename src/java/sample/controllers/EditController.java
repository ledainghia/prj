...
public class EditController extends HttpServlet {
    ...
    private static final String ERROR = "shop_cart.jsp";
    private static final String SUCCESS = "shop_cart.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (quantity <= 0) {
                ...
                request.setAttribute("message", "Update quantity of product " + id + " Fail because quantity <= 0");
                ...
                if (cart != null) {
                    if (cart.getCart().containsKey(id)) {
                        ...
                        if (check) {
                            ...
                            request.setAttribute("message", "Update quantity of product " + id + " successfully");
                        }
                    }
                }
            }
