 ...
 * @author Acer
 */
@WebServlet(name = "SearchUserAdminController", urlPatterns = {"/SearchUserAdminController"})
public class SearchUserAdminController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           List<UserDTO> users = userDAO.getUser(search);
            ...
            if (users.size() > 0) {
                ...
                url = ERROR;
                request.setAttribute("USER_ERROR", "No user found");
            }
        } catch (Exception e) {
