 ...
 * @author Acer
 */
@WebServlet(name = "DeleteClientController", urlPatterns = {"/DeleteClientController"})
        ...
        try {
            ...
            if (loginUser != null) {
                if (loginUser.getUserID().equals(userID)) {
                    request.setAttribute("ERROR", "Account is logged in. Can not delete");
                    request.setAttribute("message", "Account is logged in. Can not delete");
